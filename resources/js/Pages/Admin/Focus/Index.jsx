          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className=" space-y-6">
              <div className='flex flex-row justify-between items-center'>
                {/* start Header */}
                <div>
                  <h1 className="text-3xl font-bold text-foreground">Daftar Fokus</h1>
                </div>
                {/* end Header */}
              ...
              <Card>
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                  {/* Button Tambah User */}
                  <Link href={route('admin.fokus.create')} className="btn btn-primary rounded-lg">
                  ...
                  {focus.data.map((fokus) => (
                    <div key={fokus.id} className="border rounded-xl p-4 bg-base-100 shadow-sm">
                      ...
                      <div className="flex gap-2 mt-4">
                        <Link href={route('admin.fokus.edit', fokus)} className="btn btn-sm btn-warning btn-outline">Edit</Link>
                      </div>
                    </div>
                  ))}
                </div>
