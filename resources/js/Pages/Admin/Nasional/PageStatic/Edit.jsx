...
import { CaptionsIcon,NotebookPenIcon } from 'lucide-react'
import React, { useState } from 'react'

function Edit({ pageStatic }) {
    // Inisialisasi useForm dengan data bawaan dari database
    const { data, setData, put, processing, errors } = useForm({
        name: pageStatic.page_name || '',
        description: pageStatic.page_desk || '',
        keyword: pageStatic.page_keyword ? pageStatic.page_keyword.split(', ') : [],
        isi: pageStatic.page_isi || '',
    });

    const submit = (e) => {
        e.preventDefault();

        // Melakukan request PUT ke route update
        put(route('admin.nasional.page-static.update', pageStatic.page_id), {
            preserveScroll: true,
        });
    };
    ...
    return (
        <>
            <Head title={`Edit Page Static - ${pageStatic.page_name}`} />
