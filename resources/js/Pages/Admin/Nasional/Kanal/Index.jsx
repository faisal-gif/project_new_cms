...
function Index({ kanal, filters }) {
  ...
  const INDEX_ROUTE = route('admin.nasional.kanal.index');
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className=" space-y-6">
              <div className='flex flex-row justify-between items-center'>
                {/* start Header */}
                <div>
                  <h1 className="text-3xl font-bold text-foreground">Daftar Kanal Nasional</h1>
                </div>
                {/* end Header */}
                  ...
                  {kanal.data.map((cat) => (
                    <div key={cat.catnews_id} className="border rounded-xl p-4 bg-base-100 shadow-sm">
                      ...
                      <div className="flex justify-between items-start mb-3">
                        <div>
                          <p className="font-semibold text-base">{cat.catnews_title}</p>
                          <p className="text-sm text-gray-500">@{cat.catnews_slug}</p>
                        </div>
