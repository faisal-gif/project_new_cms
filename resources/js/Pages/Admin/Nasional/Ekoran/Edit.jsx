                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <Card padding="p-6 md:p-8" className="border border-border">
                            <h2 className="text-xl font-bold mb-6 border-b pb-3 flex justify-between items-center">
                                ...
                                <Badge className="bg-neutral-700/10 text-neutral-600 text-sm font-normal">{regularPages.length} / {MAX_REGULAR_PAGES}</Badge>
                            </h2>
                            <InputMultiImage
                        ...
                        <Card padding="p-6 md:p-8" className="border border-border">
                            ...
                            <div className="flex justify-between items-center border-b pb-4 mb-6">
                                ...
                                <Badge className="bg-amber-500/10 text-amber-600 text-sm font-normal">{spesialPages.length} / {MAX_PROMO_PAGES}</Badge>
                            </div>
                            <InputMultiImage
