...
function Index({ focus, filters }) {
  ...
  return (
    <>
      <Head title="Fokus Nasional Management" />
      <AuthenticatedLayout >
        <div className="py-12">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className=" space-y-6">
              <div className='flex flex-row justify-between items-center'>
                {/* start Header */}
                <div>
                  <h1 className="text-3xl font-bold text-foreground">Daftar Fokus Nasional</h1>
                </div>
                {/* end Header */}
                  ...
                  {focus.data.map((fokus) => (
                    <div key={fokus.focnews_id} className="border rounded-xl p-4 bg-base-100 shadow-sm">
                      ...
                      <div className="flex justify-between items-start mb-3">
                        <div>
                          <p className="font-semibold text-base">{fokus.focnews_title}</p>
