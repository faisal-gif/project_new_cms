...
function Create() {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('admin.daerah.fokus.store'));
    };

    return (
        <>
            <Head title="Tambah Fokus Daerah" />
            <AuthenticatedLayout >
                <div className="py-12">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className=" space-y-6">
                            ...
                            <div className='flex flex-col md:flex-row justify-between md:items-center gap-2'>
                                <div>
                                    <h1 className="text-3xl font-bold text-foreground">Tambah Fokus Daerah</h1>
                                </div>
                                <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Daerah' }, { label: 'Fokus' }, { label: 'Tambah Fokus' }]} />
                            </div>
                                        ...
                                        <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
                                            ...
                                            <div className='w-full'>
                                                <InputImage
                                                    ...
                                                    targetWidth={1200}  // Resolusi portrait atau square untuk mobile
                                                    targetHeight={300}
                                                />
