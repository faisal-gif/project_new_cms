...
function Index({ ads_daerah, filters }) {
  ...
  const INDEX_ROUTE = route('admin.ads.daerah.index');
            ...
            <div className=" space-y-6">
              ...
              <Card>
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                  {/* Button Tambah User */}
                  <Link href={route('admin.ads.daerah.create')} className="btn btn-primary rounded-lg">
                  ...
                  {ads_daerah.data.map((ad) => (
                    <div key={ad.id} className="border rounded-xl p-4 bg-base-100 shadow-sm">
                      ...
                      <div className="flex gap-2 mt-4">
                        <Link href={route('admin.ads.daerah.edit', ad)} className="btn btn-sm btn-warning btn-outline">Edit</Link>
                      </div>
                    </div>
                  ))}
                </div>
