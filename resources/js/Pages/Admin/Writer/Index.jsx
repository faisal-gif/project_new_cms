            ...
            <div className=" space-y-6">
              ...
              <Card>
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                  {/* Button Tambah User */}
                  <Link href={route('admin.writer.create')} className="btn btn-primary rounded-lg">
                  ...
                  {writers.data.map((writer) => (
                    <div key={writer.id} className="border rounded-xl p-4 bg-base-100 shadow-sm">
                      ...
                      <div className="flex gap-2 mt-4">
                        <Link href={route('admin.writer.edit', writer)} className="btn btn-sm btn-warning btn-outline">Edit</Link>
                      </div>
                    </div>
                  ))}
                </div>
