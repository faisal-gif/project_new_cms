                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="space-y-6">
                            <div className='flex flex-row justify-between items-center'>
                                ...
                                <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Kopi Times' }, { label: 'Paket Berita' }]} />
                            </div>
                                ...
                                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                                    {hasPermission(['create paket kopi-times']) && (
                                        <Button asChild className="rounded-lg">
                                            <Link href={route('admin.kopi-times.paket.create')}>
                                            ...
                                            {hasPermission(['edit paket kopi-times']) && (
                                                <div className="flex gap-2 mt-4">
                                                    <Button asChild size="sm" variant="outline" className="w-full border-amber-500 text-amber-600 hover:bg-amber-50 hover:text-amber-700 dark:border-amber-500/60 dark:text-amber-400 dark:hover:bg-amber-950/40">
                                                        <Link href={route('admin.kopi-times.paket.edit', paket.id)}>Edit Paket</Link>
                                                    </Button>
                                                </div>
                                            )}
                                        </div>
                                                    ...
                                                    <TableCell>
                                                        {hasPermission(['edit paket kopi-times']) && (
                                                            <div className="flex justify-end gap-2">
                                                                ...
                                                                <Link href={route('admin.kopi-times.paket.edit', paket.id)}>Edit</Link>
                                                            </Button>
                                                            </div>
                                                        )}
                                                    </TableCell>
