...
export default function Index({ payments, packages, statistics, filters }) {
    ...
    const INDEX_ROUTE = route('admin.ajp.transaction.index');
                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="space-y-6">
                            ...
                            <div className='flex flex-row justify-between items-center'>
                                <div>
                                    <h1 className="text-3xl font-bold text-foreground">Daftar Transaksi AJP</h1>
                                ...
                                <Breadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'AJP' }, { label: 'Transaksi' }]} />
                            </div>
