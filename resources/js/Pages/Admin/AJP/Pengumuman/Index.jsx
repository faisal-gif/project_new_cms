                            ...
                            <Card>
                                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                                    ...
                                    {hasPermission('create pengumuman ajp') && (
                                        <Link href={route('admin.ajp.pengumuman.create')} className="btn btn-primary rounded-lg">
                                        ...
                                        <div key={item.id} className="border rounded-xl p-4 bg-base-100 shadow-sm">
                                            ...
                                            <div className="flex items-center justify-end text-xs pt-3 mt-3 border-t">
                                                {hasPermission('edit pengumuman ajp') && (
                                                    <Link href={route('admin.ajp.pengumuman.edit', item.id)} className="btn btn-xs btn-warning btn-soft gap-1">
                                                ...
                                                return (
                                                    <tr key={item.id} className="border-b border-base-200 last:border-0 hover:bg-base-200/40 transition-colors">
                                                        ...
                                                        <td className="py-4 align-top text-right">
                                                            {hasPermission('edit pengumuman ajp') && (
                                                                <Link
                                                                    href={route('admin.ajp.pengumuman.edit', item.id)}
