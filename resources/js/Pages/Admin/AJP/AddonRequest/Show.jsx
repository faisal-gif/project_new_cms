            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div className='flex items-center gap-4'>
                        <Button asChild variant="ghost" size="icon" className="bg-muted"><Link href={route('admin.ajp.addon-requests.index')}>
                            <ArrowLeft size={20} />
                        </Link></Button>
                        <div>
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <Card>
                                <div className="flex justify-between items-center mb-4 border-b pb-2">
                                    ...
                                    <Button asChild variant="outline" size="sm" className="border-primary text-primary hover:bg-primary/10"><Link href={route('admin.ajp.news.show', addon.news_id)} target="_blank">
                                        Lihat Full Page
                                    </Link></Button>
                                </div>
