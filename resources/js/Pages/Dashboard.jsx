...
import {
    ...
    Wallet, Receipt, UserPlus, TrendingUp, Eye, UserCog, ChevronRight
} from 'lucide-react';
        ...
        <AuthenticatedLayout>
            ...
            <div className="py-4 md:py-6">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    {/* Akses cepat Profil Editor (khusus role editor) */}
                    {auth?.roles?.includes('editor') && (
                        <Link
                            href={`${route('profile.edit')}#profil-editor`}
                            className="mb-6 flex items-center gap-3 rounded-lg border border-indigo-100 bg-indigo-50 p-4 transition hover:bg-indigo-100"
                        >
                            <UserCog className="w-6 h-6 text-indigo-600 flex-shrink-0" />
                            <div className="flex-1">
                                <div className="font-semibold text-indigo-900">Profil Editor</div>
                                <div className="text-xs text-indigo-700">Kelola nama, alias, foto & no. WhatsApp editor kamu.</div>
                            </div>
