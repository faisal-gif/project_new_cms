...
use App\Http\Requests\PengumumanAjpRequest;
...
class PengumumanAjpController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        $pengumuman = PengumumanWebBerbayar::where('type', 1)
        ...
        return Inertia::render('Admin/AJP/Pengumuman/Index', [
    ...
    {
        return Inertia::render('Admin/AJP/Pengumuman/Create');
    }

    // Memproses data yang dikirim dari form
    public function store(PengumumanAjpRequest $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.ajp.pengumuman.index')
                ->with('success', 'Pengumuman AJP berhasil diterbitkan!');
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function edit($id)
    {
        ...
        return Inertia::render('Admin/AJP/Pengumuman/Edit', [
            'pengumuman' => $pengumuman
        ]);
    }
     ...
     */
    public function update(PengumumanAjpRequest $request, $id)
    {
        $pengumuman = PengumumanWebBerbayar::findOrFail($id);
        ...
        try {
            ...
            return redirect()->route('admin.ajp.pengumuman.index')
                ->with('success', 'Pengumuman AJP berhasil diperbarui!');
        } catch (\Exception $e) {
            DB::rollback();
