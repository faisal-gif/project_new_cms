...
class NetworkController extends Controller
{
    ...
    {
        return Inertia::render('Admin/Network/Create');
    }
    ...
    public function store(NetworkFormRequest $request)
    {
        ...
        return redirect()->route('admin.network.index')->with('success', 'Network Berhasil Ditambahkan');
    }
    ...
    {
        return Inertia::render('Admin/Network/Edit', [
            'network' => $network,
        ]);
    }
