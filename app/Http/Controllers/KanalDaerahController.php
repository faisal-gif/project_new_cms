...
class KanalDaerahController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Admin/Daerah/Kanal/Index', [
            'kanal'   => $kanal,
    ...
    {
        return Inertia::render('Admin/Daerah/Kanal/Create');
    }
     ...
     */
    public function show(KanalDaerah $kanal)
    {
        //
    }
     ...
     */
    public function edit(KanalDaerah $kanal)
    {
        return Inertia::render('Admin/Daerah/Kanal/Edit', [
            'kanal' => $kanal,
        ]);
    }
     ...
     */
    public function update(KanalFormRequest $request, KanalDaerah $kanal)
    {
        $auth = Auth::user();
     ...
     */
    public function destroy(KanalDaerah $kanal)
    {
        //
    }
}
