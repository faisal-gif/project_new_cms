...
class AjpAddonRequestController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Admin/AJP/AddonRequest/Index', [
            'requests' => $requests,
    ...
    public function show($id)
    {
        ...
        return Inertia::render('Admin/AJP/AddonRequest/Show', [
            'addon' => $addon
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('admin.ajp.addon-requests.index')->with('success', 'Status antrean berhasil diperbarui.');
        } catch (\Exception $e) {
