...
class KanalNasionalFormRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $kanalId = is_object($kanal) ? $kanal->catnews_id : $kanal;
        ...
        return [
            ...
            'slug' => [
                'required',
                'string',
                Rule::unique('mysql_nasional.news_category', 'catnews_slug')->ignore($kanalId, 'catnews_id'),
            ],
    ...
    {
        return [
            'order.required' => 'Order Wajb diisi',
